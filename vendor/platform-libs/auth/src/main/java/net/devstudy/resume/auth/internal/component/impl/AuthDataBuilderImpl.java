...
import net.devstudy.resume.auth.api.component.AuthDataBuilder;
import net.devstudy.resume.shared.component.TranslitConverter;

@Component
public class AuthDataBuilderImpl implements AuthDataBuilder {
    ...
    public AuthDataBuilderImpl(TranslitConverter translitConverter) {
